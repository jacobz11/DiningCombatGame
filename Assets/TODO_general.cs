namespace Assets
{
    internal class TODO_general
    {
        // TODO : go over all the [SerializeField] Check if you need it, if it's better to use scriptable objects
        // TODO : Go through all the code to replace internal
